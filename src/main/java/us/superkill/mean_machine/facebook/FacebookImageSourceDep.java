...
public class FacebookImageSourceDep extends ImageSource {
	
	private static final Logger log = 
			LogManager.getLogger(FacebookImageSourceDep.class);
...
//	private String imageDir;
	...
	public FacebookImageSourceDep(FacebookClient fbClient, 
